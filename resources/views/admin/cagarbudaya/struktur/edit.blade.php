            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Edit Cagar Budaya Bangunan</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form class="needs-validation"
                                    action="{{ route('cagarbudaya_struktur.update', $data->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="kodepos" value="{{ $data->kodepos }}" name="kodepos"
                                    ...
                                    <div class="form-group">
                                        <label>Panjang</label>
                                        <input type="text" class="form-control" id="panjang" value="{{ $data->panjang }}" name="panjang"
                                            placeholder="Panjang">
                                    </div>
                                    <div class="form-group">
                                        <label>Lebar</label>
                                        <input type="text" class="form-control" id="lebar" value="{{ $data->lebar }}" name="lebar"
                                            placeholder="Lebar">
                                    </div>
                                    <div class="form-group">
                                        <label>Tinggi</label>
                                        <input type="text" class="form-control" id="tinggi" value="{{ $data->tinggi }}" name="tinggi"
                                            placeholder="Tinggi">
                                    </div>
                                    <div class="form-group">
                                        <label>Tebal</label>
                                        <input type="text" class="form-control" id="tebal" value="{{ $data->tebal }}" name="tebal"
                                            placeholder="Tebal">
                                    </div>
                                    <div class="form-group">
                                        <label>Diameter</label>
                                        <input type="text" class="form-control" id="diameter" value="{{ $data->Diameter }}" name="diameter"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="batas_utara" value="{{ $data->utara }}" name="utara"
                                            placeholder="Batas Utara">
                                    </div>
                                    <div class="form-group">
                                        <label>Batas Selatan</label>
                                        <input type="text" class="form-control" id="batas_selatan" value="{{ $data->selatan }}" name="selatan"
                                            placeholder="Batas Selatan">
                                    </div>
                                    <div class="form-group">
                                        <label>Batas Timur</label>
                                        <input type="text" class="form-control" id="batas_timur" value="{{ $data->timur }}" name="timur"
                                            placeholder="Batas Timur">
                                    </div>
                                    <div class="form-group">
                                        <label>Batas Barat</label>
                                        <input type="text" class="form-control" id="batas_barat" value="{{ $data->barat }}" name="barat"
                            ...
                            <div class="col-6">
                                <img src="{{ $data->Foto_CB() }}" alt="foto struktur" width="80%">
                                ...
                                <a href="{{ route('cagarbudaya_struktur') }}">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-sm-12 col-12">
                        <form class="needs-validation" novalidate=""
                            action="{{ route('cagarbudaya_struktur.editlokasi', $data->id) }}" method="POST"
                            enctype="multipart/form-data">
