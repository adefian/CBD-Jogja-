            ...
            <div class="col-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1 class="mb-0 font-weight-bold text-gray-800">Cagar Budaya (Kawasan)</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="dataTables" class="table table-hover table-bordered">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="text-align: center; vertical-align: middle;">Foto Kawasan</th>
                                ...
                                <tbody>
                                    ...
                                    <tr style="text-align: center; vertical-align: middle;">
                                        ...
                                        <td>
                                            <img src="{{ $data->Foto_CB() }}" alt="foto kawasan" height="80px">
                                        </td>

                                        <td>
                                        <a href="{{ route('cagarbudaya_kawasan.edit', $data->id) }}">
...
@include('admin.cagarbudaya.kawasan.tambah')
...
function deleteData(id) {
    var id = id;
    var url = '{{route("cagarbudaya_kawasan.hapus", ":id") }}';
