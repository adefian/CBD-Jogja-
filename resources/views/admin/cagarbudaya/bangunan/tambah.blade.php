...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form class="needs-validation" action="{{ route('cagarbudaya_bangunan.create') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="koordinat_x" name="latitude" placeholder="Koordinat X">
                    </div>
                    <div class="form-group">
                        <label>Koordinat Google y</label>
                        <input type="number" class="form-control" id="koordinat_y" name="longitude" placeholder="Koordinat Y">
                    </div>
                    <div class="form-group">
                        <label>Pemilik</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="riwayat" name="riwayat" placeholder="Riwayat Kepemilikan"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ketinggian" name="ketinggian" placeholder="Ketinggian">
                    </div>
                    <div class="form-group">
                        <label>Kondisi</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="sejarah" name="sejarah" placeholder=""></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" required class="form-control" id="foto" name="foto" placeholder="" required>
                    </div>
