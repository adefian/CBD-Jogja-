...
<div class="content">
    ...
    <div class="animated fadeIn">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cagar Budaya (Situs)</h1>
                            ...
                            <table id="dataTable" class="table table-hover table-bordered">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th colspan="6" style="text-align: center; vertical-align: middle;">Ciri-ciri Situs</th>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Situs</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" id="nama" name="nama" placeholder="Nama Situs">
                    </div>
                    <div class="form-group">
                        <label>Alamat</label>
